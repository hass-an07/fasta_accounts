                ...
                <div class="tm_invoice_in">
                    <div class="tm_invoice_head tm_align_center tm_mb20">
                        <div class="tm_invoice_left">
                            <div class="tm_logo"><img src="{{asset('invoice/img/invoice_logo.jpg')}}" alt="Logo"></div>
                        </div>
                    ...
                    <div class="tm_invoice_info tm_mb20">
                        ...
                        <div class="tm_invoice_info_list">
                            <p class="tm_invoice_number tm_m0">Invoice No: <b
                                    class="tm_primary_color">#{{$invoice->invoice_number}}</b></p>
                            <p class="tm_invoice_date tm_m0">Date: <b class="tm_primary_color">{{$invoice->date}}</b>
                            </p>
                        </div>
                    </div>
                    <div class="tm_invoice_head tm_mb10">
                        <div class="tm_invoice_left">
                            ...
                            <p>
                                ...
                                {{$invoice->customer->billing_address}}, {{$invoice->customer->country}}<br>
                    ...
                    <div class="tm_table tm_style1 tm_mb30">
                        ...
                        <div class="tm_invoice_footer">
                            <div class="tm_left_footer">
                                ...
                                <p class="tm_m0">Credit Card - {{$invoice->account_number}} <br>Amount: $1732</p>
                            </div>
